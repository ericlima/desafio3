...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderResponseList, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderResponseList, error) {
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*OrderResponseList, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*OrderResponseList, error) {
